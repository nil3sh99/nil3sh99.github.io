  ...
  return (
    <div className="text-center w-full mt-16">
      <p className="text-gray-600 mb-4">
        Made with <span role="img" aria-label="heart">💙</span> by <a className="text-blue-500 hover:underline" href="https://github.com/nil3sh99/port-react">Nilesh Aggarwal</a>
      </p>
      <p className="text-gray-500 mb-4">
        Inspired from <a className="text-blue-500 hover:underline" href="https://github.com/BraydenTW/react-tailwind-portfolio"> BraydenTW </a>
      </p>
